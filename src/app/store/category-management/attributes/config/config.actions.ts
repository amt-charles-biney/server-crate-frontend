...
import { AllCategories, CategoryAndConfig, Configuration, ConfigurationEdit, EditConfigResponse } from "../../../../types";
...
export const getCategoriesAndConfig = createAction('[category] get categories and config', props<{ page: number }>())

export const gotCategoryAndConfig = createAction('[category] got categories and config', props<AllCategories>())
